...
class Minimizer {
    ...
    public:
         ...
         * @param algo Algorithm to use : "LSHADE", "AGSK", "DE", "JADE", "jSO", "IMODE", "NelderMead", "LSRTDE", "RDEX", "NLSHADE_RSP", "NLSHADE_LBC", "j2020", "PSO", "SPSO2011", "DMSPSO", "LSHADE_cnEpSin", "GradientDescent", or alias "GD"
            ...
            std::map<std::string, ConfigValue> options = std::map<std::string, ConfigValue>() ) 
        {
            ...
            else if (algoUpper == "GradientDescent") optimizer = new GradientDescent(func, bounds, x0, data, callback, maxevals, seed, options);
         ...
         * @param data Additional data to pass to the objective function.
         * @param callback Callback invoked with intermediate results. Return true to stop optimization; return false to continue.
         * @param algo Algorithm to use : "LSHADE", "DE", "JADE", "jSO", "DE", "NelderMead", "LSRTDE", "RDEX", "NLSHADE_RSP", "NLSHADE_LBC", "j2020", "PSO", "SPSO2011", "DMSPSO", "LSHADE_cnEpSin", "GradientDescent", or alias "GD"
         * @param maxevals The maximum number of function evaluations.
         * @param seed global seed
         * @param options Option object, which specify further configurational settings for the algorithm.
         */
