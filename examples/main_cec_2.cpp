...
double minimize_cec_functions(int function_number, int dimension, int population_size, int max_evals, int year=2022, std::string algo="ARRDE", int seed=-1) {
    ...
    minion::Minimizer optimizer (objective_function,  bounds, x0, cecfunc, callBack, algo, max_evals,  seed, settings);
...
int main(int argc, char* argv[]) {
    ...
    std::vector<int> Nevals = {500*dimension, 1000*dimension, 2000*dimension, 3000*dimension, 4000*dimension, 5000*dimension, 6000*dimension, 
                                7000*dimension, 8000*dimension, 9000*dimension, 10000*dimension};
