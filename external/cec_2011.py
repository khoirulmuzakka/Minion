...
class Problem01:
    def __init__(self, path="/matlab_cec2011/pro_1_to_8"):
...
class Problem09:
    def __init__(self, path="/matlab_cec2011/pro_9"):
        self.path_file = os.path.dirname(os.path.abspath(__file__)) + path
        self.eng = matlab.engine.start_matlab()
        self.eng.addpath(self.path_file, nargout=0)
        self.ndim = 126
...
class Problem10:
    def __init__(self, path="/matlab_cec2011/pro_10"):
        self.path_file = os.path.dirname(os.path.abspath(__file__)) + path
        self.eng = matlab.engine.start_matlab()
...
class Problem12:
    def __init__(self, path="/matlab_cec2011/pro_12_13"):
        self.path_file = os.path.dirname(os.path.abspath(__file__)) + path
        self.eng = matlab.engine.start_matlab()
        self.eng.addpath(self.path_file)
        self.ndim = 26
