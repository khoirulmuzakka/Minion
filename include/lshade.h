...
/**
 * @class LSHADE 
 * @brief Class implementing of the LSHADE algorithm.
 */
class LSHADE : public DE_Base {
    public:
    ...
    public :
         ...
         */
        LSHADE(MinionFunction func, const std::vector<std::pair<double, double>>& bounds, void* data = nullptr, 
